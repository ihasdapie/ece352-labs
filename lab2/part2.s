...
mov r5, r0; // loop counter
            //movia r6, IN_LIST_SIZE; # loop condition; 9 halfwords

PNLOOP:
//bge r5, r6, PNLOOP_END;		# check if we've gone through the whole list

// load number from memory
movia r4, IN_LIST;	//get word from list at the current pointer location
add r4, r4, r5;
add r4, r4, r5;		//incr pointer twice bc halfword = 2 bytes (r5 incr by 1 every time)
ldh r9, 0(r4);		//load value from list at current pointer into r9
beq r9, r0, PNLOOP_END;
